...
<head>
	...
	<title><?php echo $template['title'].' - 管理系统' ?></title>
    ...
    <link rel="shortcut icon" href="<?php echo BASE_URL . $this->admin_theme->path; ?>/img/favicon.ico">
...
<body>
	...
	<footer class="clearfix">
		<div class="wrapper">
			<p class="credits">Copyright &copy;<?php echo date('Y'); ?> <?php echo $this->settings->site_name; ?></p>
		</div>
	</footer>
